...
const text = (
  ...
  >
    The path here is constricted by two interesting plants. On the right is the
    native,{" "}
    <Text style={{ fontWeight: "bold" }}>
      red-barked manzanita (
      <Text style={{ fontStyle: "italic" }}>Arctostaphylos</Text> ‘Ruth
      Bancroft’).
    </Text>
    {"\n"} {"\n"}
    The tree on the left, with{" "}
    <Text style={{ fontWeight: "bold" }}>
      weeping foliage, is the Australian{" "}
      <Text style={{ fontStyle: "italic" }}>Melaleuca preissiana</Text>,{" "}
    </Text>
...
const popUpText = (
  <Text style={{ padding: 15, fontFamily: "Times New Roman", fontSize: "20" }}>
    ...
    Indigenous Californians use manzanita berries for cider (among other
    things), and the Australian Aboriginal people use the tea tree oil for
