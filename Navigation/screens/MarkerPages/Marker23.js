...
const text = 
    <Text style={{ padding: 20, paddingBottom: 37, fontFamily: "Times New Roman", fontSize: '20' }}>   
        ...
        to the repetition of the bright-green, low-clumping <Text style={{fontWeight: "bold", fontStyle: "italics"}}>Agave mitis</Text>, 
        to the left where the gigantic dark-green leaves of <Text style={{fontWeight: "bold", fontStyle: "italics"}}>Agave salmiana</Text> dominate.
    </Text>
